...
class Delexpensecategory {
  static Future<dynamic> DeleteExpenseCategory(id) async {
    ...
    try {
      final response = await dio.delete(
        '/${shopresponse['shopNameslug']}/${shopresponse['branchNameslug']}/expense-categories/$id',
