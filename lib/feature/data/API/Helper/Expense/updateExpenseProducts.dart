...
class Updateexpenseproducts {
  static Future<dynamic> UpdateExpenseProduct(data, String id) async {
    ...
    try {
      final response = await dio.put(
        '/${shopresponse['shopNameslug']}/${shopresponse['branchNameslug']}/expense-products/$cleanId',
