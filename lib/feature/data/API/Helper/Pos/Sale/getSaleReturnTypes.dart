...
class Getsalereturntypes {
  static Future<dynamic> getSaleReturnTypes([int page = 0]) async {
    ...
    try {
      final response = await dio.get(
        '/${shopresponse['shopNameslug']}/${shopresponse['branchNameslug']}/sale-return-types?page=$page',
