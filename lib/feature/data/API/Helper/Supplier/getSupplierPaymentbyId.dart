...
class Getsupplierpaymentbyid {
  static Future<dynamic> getSupplierPaymentById(id) async {
    ...
    try {
      final response = await dio.get(
        '/${shopresponse['shopNameslug']}/${shopresponse['branchNameslug']}/supplier-payments/$id',
