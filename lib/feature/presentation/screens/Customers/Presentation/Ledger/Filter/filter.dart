...
class LedgerCustomerFilter extends StatefulWidget {
  final Function filterSubmit;
  const LedgerCustomerFilter({super.key, required this.filterSubmit});

  @override
  State<LedgerCustomerFilter> createState() => _LedgerCustomerFilterState();
}

class _LedgerCustomerFilterState extends State<LedgerCustomerFilter> {
