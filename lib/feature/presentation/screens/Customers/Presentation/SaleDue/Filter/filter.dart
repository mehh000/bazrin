...
class SupplierAdvanceFilter extends StatefulWidget {
  final Function filterSubmit;
  const SupplierAdvanceFilter({super.key, required this.filterSubmit});

  @override
  State<SupplierAdvanceFilter> createState() => _SupplierAdvanceFilterState();
}

class _SupplierAdvanceFilterState extends State<SupplierAdvanceFilter> {
