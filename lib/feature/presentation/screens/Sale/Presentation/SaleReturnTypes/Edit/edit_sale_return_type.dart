...
import 'package:bazrin/feature/data/API/Helper/Pos/Sale/updateSaleReturnType.dart';
import 'package:bazrin/feature/presentation/common/classes/imports.dart';

class EditSaleReturnType extends StatefulWidget {
  final dynamic data;
  const EditSaleReturnType({super.key, required this.data});

  @override
  State<EditSaleReturnType> createState() => _EditSaleReturnTypeState();
}

class _EditSaleReturnTypeState extends State<EditSaleReturnType> {
  ...
  void add() async {
    ...
    try {
      final response = await Updatesalereturntype.UpdateSaleReturnTypey(data, widget.data['id']);
      if (response == 'success') {
