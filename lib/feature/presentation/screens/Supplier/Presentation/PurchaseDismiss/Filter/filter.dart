...
class SupplierPurchaseDismissFilter extends StatefulWidget {
  final Function filterSubmit;
  const SupplierPurchaseDismissFilter({super.key, required this.filterSubmit});

  @override
  State<SupplierPurchaseDismissFilter> createState() => _SupplierPurchaseDismissFilterState();
}

class _SupplierPurchaseDismissFilterState extends State<SupplierPurchaseDismissFilter> {
