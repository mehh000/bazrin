...
class ReturnDuePaySupplier extends StatefulWidget {
  const ReturnDuePaySupplier({super.key});

  @override
  State<ReturnDuePaySupplier> createState() => _ReturnDuePaySupplierState();
}

class _ReturnDuePaySupplierState extends State<ReturnDuePaySupplier> {
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Headercomponent(title: "Return Due "),
                      Container(
                        width: double.infinity,
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.only(
