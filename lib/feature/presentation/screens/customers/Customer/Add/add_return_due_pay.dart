...
class AddReturnDuePay extends StatefulWidget {
  final dynamic data;
  const AddReturnDuePay({super.key, required this.data});

  @override
  State<AddReturnDuePay> createState() => _AddReturnDuePayState();
}

class _AddReturnDuePayState extends State<AddReturnDuePay> {
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Headercomponent(title: "Return Due Pay"),
                      isloading
                          ? Customindicator()
                          : Container(
                              width: double.infinity,
