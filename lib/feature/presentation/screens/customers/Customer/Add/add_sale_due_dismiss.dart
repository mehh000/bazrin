...
class AddSaleDueDismiss extends StatefulWidget {
  final dynamic data;
  const AddSaleDueDismiss({super.key, required this.data});

  @override
  State<AddSaleDueDismiss> createState() => _AddSaleDueDismissState();
}

class _AddSaleDueDismissState extends State<AddSaleDueDismiss> {
  ...
  void initState() {
    ...
    totalreceiveableController.text =
        widget.data['saleReturnTotalRemaining']?.toString() ?? ''.toString();
    getSupPayDetails();
  }
  ...
  void submitData() async {
    ...
    dynamic fromData = {
      ...
      "type": "SALE_RETURN_DUE_DISMISSAL",
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Headercomponent(title: "Sale Due Dismiss"),
                      isloading
                          ? Customindicator()
                          : Container(
                              width: double.infinity,
