...
class SaleDueDismiss extends StatefulWidget {
  const SaleDueDismiss({super.key});

  @override
  State<SaleDueDismiss> createState() => _SaleDueDismissState();
}

class _SaleDueDismissState extends State<SaleDueDismiss> {
