...
class SupplierPurchaseDismissCard extends StatefulWidget {
  final dynamic ret;
  const SupplierPurchaseDismissCard({super.key, required this.ret});

  @override
  State<SupplierPurchaseDismissCard> createState() =>
      _SupplierPurchaseDismissCardState();
}

class _SupplierPurchaseDismissCardState
    extends State<SupplierPurchaseDismissCard> {
