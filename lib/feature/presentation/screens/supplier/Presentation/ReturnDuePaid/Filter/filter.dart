...
class ReturnDuePaidFilter extends StatefulWidget {
  ...
  const ReturnDuePaidFilter({super.key, required this.filterSubmit});

  @override
  State<ReturnDuePaidFilter> createState() => _ReturnDuePaidFilterState();
}

class _ReturnDuePaidFilterState extends State<ReturnDuePaidFilter> {
