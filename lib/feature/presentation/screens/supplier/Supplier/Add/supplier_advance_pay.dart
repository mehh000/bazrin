...
class SupplierAdvancePay extends StatefulWidget {
  final dynamic data;
  const SupplierAdvancePay({super.key, required this.data});

  @override
  State<SupplierAdvancePay> createState() => _SupplierAdvancePayState();
}

class _SupplierAdvancePayState extends State<SupplierAdvancePay> {
  ...
  void initState() {
    ...
    totalreceiveableController.text =
        widget.data['advanceTotalAmount']?.toString() ?? ''.toString();
    getSupPayDetails();
  }
