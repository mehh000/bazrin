...
class SupplierPurchaseDueDismiss extends StatefulWidget {
  final dynamic data;
  const SupplierPurchaseDueDismiss({super.key, required this.data});

  @override
  State<SupplierPurchaseDueDismiss> createState() =>
      _SupplierPurchaseDueDismissState();
}

class _SupplierPurchaseDueDismissState
    extends State<SupplierPurchaseDueDismiss> {
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Headercomponent(title: "Purchase Due Dismiss "),
                      isloading
                          ? Customindicator()
                          : Container(
                              width: double.infinity,
