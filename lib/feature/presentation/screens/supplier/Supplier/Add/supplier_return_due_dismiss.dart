...
import 'package:bazrin/feature/presentation/common/widgets/CustomIndicator.dart';
import 'package:bazrin/feature/presentation/common/widgets/tost_message.dart';
import 'package:flutter/material.dart';
import 'package:vsc_quill_delta_to_html/vsc_quill_delta_to_html.dart';

class SupplierReturnDueDismiss extends StatefulWidget {
  final dynamic data;
  const SupplierReturnDueDismiss({super.key, required this.data});

  @override
  State<SupplierReturnDueDismiss> createState() =>
      _SupplierReturnDueDismissState();
}

class _SupplierReturnDueDismissState extends State<SupplierReturnDueDismiss> {
  ...
  void initState() {
    ...
    totalreceiveableController.text =
        widget.data['purchaseReturnTotalRemaining']?.toString() ??
        ''.toString();
    getSupPayDetails();
  }
  ...
  void submitData() async {
    ...
    dynamic fromData = {
      ...
      "type": "PURCHASE_RETURN_DUE_DISMISSAL",
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Headercomponent(title: "Return Due Dismiss "),
                      isloading
                          ? Customindicator()
                          : Container(
                              width: double.infinity,
