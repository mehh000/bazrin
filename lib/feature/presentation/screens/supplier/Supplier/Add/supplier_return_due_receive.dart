...
class SupplierReturnDueReceive extends StatefulWidget {
  final dynamic data;
  const SupplierReturnDueReceive({super.key, required this.data});

  @override
  State<SupplierReturnDueReceive> createState() =>
      _SupplierReturnDueReceiveState();
}

class _SupplierReturnDueReceiveState extends State<SupplierReturnDueReceive> {
  ...
  void submitData() async {
    ...
    dynamic fromData = {
      ...
      "type": "PURCHASE_RETURN_DUE_PAYMENT",
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Headercomponent(title: "Return Due Receive "),
                      isloading
                          ? Customindicator()
                          : Container(
                              width: double.infinity,
