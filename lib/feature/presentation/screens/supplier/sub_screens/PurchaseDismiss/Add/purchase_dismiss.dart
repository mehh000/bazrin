...
class PurchaseDismiss extends StatefulWidget {
  const PurchaseDismiss({super.key});

  @override
  State<PurchaseDismiss> createState() => _PurchaseDismissState();
}

class _PurchaseDismissState extends State<PurchaseDismiss> {
